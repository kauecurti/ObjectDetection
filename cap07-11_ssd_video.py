...
MODELS_PATH = '/Users/dmpm/Dropbox/DSA/ComputerVision/Cap07/08-SSD/ObjectDetection'
...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:
    ...
    video_writer = imageio.get_writer('%s_objetos_detectados.mp4' % input_video, fps=10)
